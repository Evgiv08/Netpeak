...
(function (window, document, $, undefined) {
  ...
  $.extend(FancyBox.prototype, {
    ...
    init: function init() {
      ...
      if (firstItem.type !== "image" && /iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream && !$("body").hasClass("fancybox-iosfix")) {
        $("body").addClass("fancybox-iosfix").css("top", -$W.scrollTop());
      }
